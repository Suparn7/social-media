                    ...
                    <div className="show_images">
                        {
                            images.map((img, index) => (
                                <div key={index} id="file_img">
                                    {
                                        img.camera ? imageShow(img.camera, themeReducer)
                                        : img.url
                                            ?<>
                                                {
                                                    img.url.match(/video/i)
                                                    ? videoShow(img.url, themeReducer)
                                                    : imageShow(img.url, themeReducer)
                                            ...
                                            :<>
                                                {
                                                    ...
                                                    ? videoShow(URL.createObjectURL(img), themeReducer)
                                                    : imageShow(URL.createObjectURL(img), themeReducer)
                                                }
                                            </>
                                    }
