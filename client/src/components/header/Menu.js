...
const Menu = () => {
    ...
    const { authReducer, themeReducer, notifyReducer } = useSelector((state) => state)
...

            {
                ...
                <li className = "nav-item dropdown" style={{opacity: '1'}}>
                    <span className = "nav-link position-relative" id = "navbarDropdown" role = "button" data-toggle = "dropdown" aria-haspopup = "true" aria-expanded = "false" >
                        ...
                        <span className="notify_length">{notifyReducer.data.length}</span>
                ...
                <li className = "nav-item dropdown" style={{opacity: '1'}}>
                    <span className = "nav-link dropdown-toggle" id = "navbarDropdown" role = "button" data-toggle = "dropdown" aria-haspopup = "true" aria-expanded = "false" >
                        <Avatar src = { authReducer.user.avatar } size="medium-avatar" />
                    </span>
                    ...
                    <div className = "dropdown-menu" aria-labelledby = "navbarDropdown" >
                        ...
                        <label htmlFor = "theme"
                            ...
                            onClick = {() => dispatch({ type: GLOBALTYPES.THEME, payload: !themeReducer }) } > { themeReducer ? 'Light mode' : 'Dark Mode' } 
                        </label>
