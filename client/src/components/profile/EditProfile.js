        ...
        <div className="edit_profile">
            ...
            <form onSubmit={handleSubmit}>
                <div className="info_avatar">
                    <img 
                        src = {avatar ? URL.createObjectURL(avatar) : authReducer.user.avatar}
                        alt="avatar"
                ...
                <div className="form-group">
                    ...
                    <input type="number" value={mobile} name="mobile" className="form-control" onChange={handleInput} />
                </div>

                <div className="form-group">
                    <label htmlFor="address">Address</label>
                    <input type="text" value={address} name="address" className="form-control" onChange={handleInput} />
                </div>

                <div className="form-group">
                    <label htmlFor="website">Website</label>
                    <input type="text" value={website} name="website" className="form-control" onChange={handleInput} />
                </div>

                <div className="form-group">
                    <label htmlFor="story">Story</label>
                    <textarea value={story} cols="30" rows="4" name="story" className="form-control" onChange={handleInput} />
